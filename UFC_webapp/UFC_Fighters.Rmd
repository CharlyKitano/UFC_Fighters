...
# <<<<<<< HEAD
# <<<<<<< HEAD
data <- read.csv("C:/Users/Eleve/Downloads./Final_Data.csv") 
data_raw <- read.csv("C:/Users/Eleve/Downloads/Final_data_raw.csv") 
...
server <- function(input, output, session) {
  output$placeholder_table <- renderDT({
    ...
    if (!is.null(input$country) && input$country != "") {
      filtered_data <- filtered_data[filtered_data["Place.of.Birth"] == input$country, ,drop=FALSE]
    }
    
    # Filter by fighting style if provided
    if (!is.null(input$fighting_style) && input$fighting_style != "") {
      filtered_data <- filtered_data[filtered_data$fighting_style == input$fighting_style, ,drop=FALSE]
    }
    ...
    if (!is.null(input$weight_class) && input$weight_class != "") {
      filtered_data <- filtered_data[filtered_data$weight_class == input$weight_class, ,drop=FALSE]
    }
