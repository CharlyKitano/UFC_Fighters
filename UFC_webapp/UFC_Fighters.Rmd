              ...
              box(
                ...
                fluidRow(
                  ...
                  column(12, selectInput("gender", "Gender:",
                                        choices = c("Male", "Female"), selected = " "
                                       )),
...
#   output$general_info_table <- renderPlot({
#     
#     counts <- table(data_raw$Country)
# 
# # Plot a pie chart
#     pie(counts, labels = names(counts), main = "Pie Chart of Unique Values")
# 
#     # columns_of_interest <- c("Country", 
